...
useHead({
  ...
  meta: [
    ...
    {
      property: "og:title",
      content: `Dev Learning - ${blog.value.head.title}`,
    },
    ...
    {
      property: "og:image",
      content: `https://www.devlearning.dev/upload/img_blog/${blog.value.head.imgshr}`,
    },
    ...
    {
      property: "og:url",
      content: `https://www.devlearning.dev/blog${blog._value._path}`,
    },
    {
  ...
  link: [
    {
      rel: "canonical",
      href: `https://www.devlearning.dev/blog${blog._value._path}`,
    },
  ],
});
</script>
