	...
	<div >
		<main>
			<section class="lg:px-[15%] px-[5%] pt-20">
				...
				>
					(Dev Learning - เป็นเว็บไซต์พัฒนาเพื่อแบ่งปันความรู้สำหรับทุกวัน)
				</h2>
			</section>
			<section class="lg:px-[15%] px-[5%] lg:pt-20 pt-14">
				...
				<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
					...
					>
						<div class="px-7 py-5 rounded-lg border-2 border-amber-700">
...
<script setup>
	...
	useHead({
		...
		meta: [
			...
			{property: "og:image", content: "https://www.devlearning.dev/icon.png",},
			...
			{property: "twitter:image", content: "https://www.devlearning.dev/icon.png",},
